...
if (params.help) {
  ...
  log.info ''
  log.info 'Mandatory argument:'
  log.info '    --outDir     STRING      base directory for reference data'
  log.info ''
  log.info 'Optional argument \'set\':'
  log.info '    --set     STRING      use a set of fa, gtf, cdna and vcf direct links within config'
  log.info ''
  log.info 'Optional arguments:'
  log.info '    --noStar     STRING      don\'t make Star refs '
